...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B7gpHW80.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DKis6J_3.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "231Ag/sumo-institute";
var SERVER_FN_BASE = "/231Ag/sumo-institute/_serverFn/";
