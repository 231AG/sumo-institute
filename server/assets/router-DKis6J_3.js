...
const sitLogo = "/231Ag/sumo-institute/assets/logo-DjZ9vs8c.jpeg";
const navLinks = [
  { to: "/", label: "Home" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 left-0 right-0 z-50 bg-secondary/95 backdrop-blur-md border-b border-secondary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: sitLogo, alt: "Sumo Institute of Technology", className: "w-10 h-10 rounded-lg object-cover" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary-foreground font-[family-name:var(--font-heading)] font-bold text-lg leading-tight block", children: "Sumo Institute" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-m font-medium tracking-wider uppercase", children: "of Technology" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: link.to,
          className: `px-3 py-2 rounded-md text-sm font-medium transition-colors ${location.pathname === link.to ? "text-gold" : "text-white hover:text-gold"}`,
          children: link.label
        },
        link.to
      )) }),
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-secondary border-t border-secondary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col px-4 py-4 gap-1", children: [
      navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: link.to,
          onClick: () => setMobileOpen(false),
          className: `px-4 py-3 rounded-lg text-sm font-medium transition-colors ${location.pathname === link.to ? "text-gold bg-secondary-foreground/5" : "text-white hover:text-gold"}`,
          children: link.label
        },
        link.to
      )),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-secondary text-secondary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: sitLogo, alt: "Sumo Institute of Technology", className: "w-10 h-10 rounded-lg object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-[family-name:var(--font-heading)] font-bold text-lg block leading-tight", children: "Sumo Institute" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs tracking-wider uppercase", children: "of Technology" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-secondary-foreground/60 text-sm leading-relaxed", children: "Technology, Skills and Innovation for Development. Building Africa's next generation of tech leaders." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-[family-name:var(--font-heading)] font-semibold text-gold mb-4", children: "Quick Links" }),
        ...
        ].map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: link.to, className: "text-secondary-foreground/60 hover:text-gold transition-colors", children: link.label }) }, link.to)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-[family-name:var(--font-heading)] font-semibold text-gold mb-4", children: "Programs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: ["BSc Networking", "BSc Data Science", "BSc Cyber Security", "BSc Telecom Engineering", "BSc Project Management"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/programs", className: "text-secondary-foreground/60 hover:text-gold transition-colors", children: p }) }, p)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-[family-name:var(--font-heading)] font-semibold text-gold mb-4", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-secondary-foreground/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 text-gold shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sumo Institute of Technology, Main Campus" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-secondary-foreground/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-gold shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+1 (231) 778 747-451" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-secondary-foreground/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-gold shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "info@sit.edu" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-secondary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-secondary-foreground/40 text-sm", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Sumo Institute of Technology. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: ["Facebook", "Twitter", "LinkedIn", "Instagram"].map((social) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-secondary-foreground/40 hover:text-gold transition-colors text-sm", children: social }, social)) })
    ] })
  ] }) });
}
...
const appCss = "/231Ag/sumo-institute/assets/styles-DatlmvYe.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4 pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold font-[family-name:var(--font-heading)] gold-text-gradient", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "The page you're looking for doesn't exist or has been moved." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-lg gold-gradient px-6 py-3 text-sm font-semibold text-secondary transition-all hover:brightness-110", children: "Go home" }) })
  ] }) });
}
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-16 md:pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppButton, {})
  ] });
}
const $$splitComponentImporter$7 = () => import("./programs-D7Yv0115.js");
const Route$7 = createFileRoute("/programs")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore SIT's BSc degree programs in Networking, Data Science, Cyber Security, MIS, Telecom Engineering, and Project Management."
    }, {
      property: "og:title",
      content: "Academic Programs — SIT"
    }, {
      property: "og:description",
      content: "Accredited BSc degree programs in technology and management disciplines."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./news-CqzZOvjw.js");
const Route$6 = createFileRoute("/news")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Latest news, events, and announcements from Sumo Institute of Technology."
    }, {
      property: "og:title",
      content: "News & Events — SIT"
    }, {
      property: "og:description",
      content: "Stay updated with the latest from SIT."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./insured-k-Qd4fDV.js");
const Route$5 = createFileRoute("/insured")({
  head: () => ({
    meta: [{
      title: "INSURED — Research & Development — Sumo Institute of Technology"
    }, {
      name: "description",
      content: "Institute of Sustainable Research and Development. Research in Data Science, Sustainability, Agriculture, Supply Chain, and Development Studies."
    }, {
      property: "og:title",
      content: "INSURED — Research at SIT"
    }, {
      property: "og:description",
      content: "Driving innovation through research in data science, sustainability, and development."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./cpsd-T_jp2Csq.js");
const Route$4 = createFileRoute("/cpsd")({
  head: () => ({
    meta: [{
      title: "CPSD — Professional Training — Sumo Institute of Technology"
    }, {
      name: "description",
      content: "Center for Professional Skills Development. Certificate and diploma programs in Data Analysis, Project Management, Digital Marketing, IT, and more."
    }, {
      property: "og:title",
      content: "CPSD — Professional Training at SIT"
    }, {
      property: "og:description",
      content: "Upskill with industry-recognized certificate and diploma programs."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-DkJWwfKb.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Sumo Institute of Technology. Contact admissions, academic departments, or general inquiries."
    }, {
      property: "og:title",
      content: "Contact Us — SIT"
    }, {
      property: "og:description",
      content: "Reach out for admissions, academic, or general inquiries."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admissions-C9CukvB6.js");
const Route$2 = createFileRoute("/admissions")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Apply to SIT. Learn about admission requirements, application process, tuition fees, and financial aid."
    }, {
      property: "og:title",
      content: "Admissions — SIT"
    }, {
      property: "og:description",
      content: "Start your application. Admission requirements, process, and tuition information."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-DLcrOv2X.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about SIT's mission, vision, values, and commitment to technology education excellence."
    }, {
      property: "og:title",
      content: "About Sumo Institute of Technology"
    }, {
      property: "og:description",
      content: "Our mission, vision, and values driving technology education in Africa."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-B8RK2_YB.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "SIT offers accredited degree programs in Networking, Data Science, Cyber Security, Telecom Engineering & more. Apply now."
    }, {
      property: "og:title",
      content: "Sumo Institute of Technology"
    }, {
      property: "og:description",
      content: "Technology, Skills and Innovation for Development. Apply now for degree programs."
    }]
  }),
...
const InsuredRoute = Route$5.update({
  id: "/insured",
  path: "/insured",
  getParentRoute: () => Route$8
});
const CpsdRoute = Route$4.update({
  id: "/cpsd",
  path: "/cpsd",
  getParentRoute: () => Route$8
});
